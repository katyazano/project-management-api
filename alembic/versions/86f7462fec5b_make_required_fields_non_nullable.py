...
def upgrade() -> None:
    ...
    op.alter_column(
        "documents", "file_name", existing_type=sa.VARCHAR(), nullable=False
    )
    op.alter_column("documents", "s3_key", existing_type=sa.VARCHAR(), nullable=False)
    op.alter_column(
        "documents", "file_size", existing_type=sa.INTEGER(), nullable=False
    )
    op.alter_column(
        "documents", "project_id", existing_type=sa.INTEGER(), nullable=False
    )
...
def downgrade() -> None:
    ...
    op.alter_column(
        "documents", "project_id", existing_type=sa.INTEGER(), nullable=True
    )
    op.alter_column("documents", "file_size", existing_type=sa.INTEGER(), nullable=True)
    op.alter_column("documents", "s3_key", existing_type=sa.VARCHAR(), nullable=True)
    op.alter_column("documents", "file_name", existing_type=sa.VARCHAR(), nullable=True)
    # ### end Alembic commands ###
